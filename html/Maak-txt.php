...
<div>
    ...
    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
        Voeg een TXT record toe!</button>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">TXT record toevoegen</h5>
                ...
                <div class="modal-body">
                    <form style="white-space:nowrap" class="form-horizontal">
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-2">TXT_regels</label>
                            <div class="input-group mb-3">
                                <textarea style="width:450px" class="control-label col-sm-2"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary">TXT record toevoegen</button>
                </div>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="WijzigenModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">TXT record Wijzigen</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form style="white-space:nowrap" class="form-horizontal">
            ...
            <div class="modal-footer">
                <button type="submit" class="btn btn-primary">TXT record wijzigen</button>
            </div>
        </div>
    </div>
</div>
